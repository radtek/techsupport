...
public interface WorksheetService {
     ...
     *
     * @param pageNo        起始记录数
     * @param pagesize      每页最大显示数目
     * @param assignee      指派用户
     * @param activity      环节名称
     * @param candidateUser 指派候选人
     * @param slNo          技术支持负责人ID
     * @param region        地区编号
     * @param stNo          支持单编码
     * @param sort          排序列
     * @param dir           排序方式
    ...
    Page getWorksheetTaskForPage(int pageNo, int pagesize, String assignee,
                                 String activity, String candidateUser, String slNo, String region, String stNo, String sort, String dir);
