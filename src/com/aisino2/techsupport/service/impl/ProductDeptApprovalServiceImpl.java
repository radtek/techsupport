 ...
 */
@Component
public class ProductDeptApprovalServiceImpl implements IDeptApprovalService {
	...
	public void insertDeptApproval(String taskId, SupportTicket st,
		...
		timeChange.setType(Constants.ST_TIME_CHANGE_TYPE_PRODUCT);
		...
		// 添加本部門審批的人員
		var.put("departApprUserId__product", tracking.getProcessor()
				.getUserid());
